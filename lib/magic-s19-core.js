...
/**
 * S19 core: textbook-semester mapping + hard lock + clue/question fallback + guided clue policy
...
const GUIDED_WRITING_CLUE_POLICY = {
  defaultMaxClues: 5,
  beginnerMaxClues: 7,
  middle1Generous: true,
  noteKo: "중1 및 기초 학습 단계에서는 clue를 더 풍부하게 제공한다.",
  noteEn: "Provide more generous clues for middle1 and beginner-level guided writing sets."
};
